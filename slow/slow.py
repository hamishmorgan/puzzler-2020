...
TIME_UNITS = (
    ...
    ("moments", 90),
    ("chris meeting latenesses", math.pi * SECONDS_PER_MINUTE),
    ("hectoseconds", 100),
    ...
    ("dog years", 7 * SECONDS_PER_TROPICAL_YEAR), # yes, I know there are two entire contradictory definitions of dog years here
    ...
    ("megawarhols", 15 * SECONDS_PER_MINUTE * 10e+6),
    ("teraseconds", 10e+12),
    ("megayears", 10e+6 * SECONDS_PER_TROPICAL_YEAR),
    ("gigawarhols", 15 * SECONDS_PER_MINUTE * 10e+9),
    ("petaseconds", 10e+15),
    ("galactic years", 2.3e+8 * SECONDS_PER_TROPICAL_YEAR),
    ("aeons", 10e+9 * SECONDS_PER_TROPICAL_YEAR),
    ("exaseconds", 10e+18),
    ("zettaseconds", 10e+21),
    ("yottaseconds", 10e+24)
)
